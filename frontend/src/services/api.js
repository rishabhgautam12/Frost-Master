...
export const salesAPI = {
  ...
  getQuotations:           (params = {}) => request(`/sales/quotations/all?${new URLSearchParams(params)}`),
  createQuotation:         (body)        => request("/sales/quotations", { method: "POST", body: JSON.stringify(body) }),
  updateQuotation:         (id, body)    => request(`/sales/quotations/${id}`, { method: "PUT", body: JSON.stringify(body) }),
